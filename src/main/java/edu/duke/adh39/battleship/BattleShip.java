...
public class BattleShip<T> extends BasicShip<T> {
   ...
   */
  public BattleShip(String name, Coordinate topLeft, Character Ori, T data, T onHit) {
   ...
   */
  public BattleShip(String name, Coordinate topLeft, Character Ori , SimpleShipDisplayInfo<T> me, SimpleShipDisplayInfo<T> enemy) {
